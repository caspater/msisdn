...
test("it returns true if number is valid when auto clean is off", () => {
    expect(msisdn("0888800900", { autoClean: false }).clean().isValid()).toBe(true);
    expect(msisdn("0888 800 900", { autoClean: false }).clean().isValid()).toBe(true);
    expect(msisdn("265 888 800 900", { autoClean: false }).clean().isValid()).toBe(true);
    expect(msisdn("+265 888 800 900", { autoClean: false }).clean().isValid()).toBe(true);
    expect(msisdn("888 800 900", { autoClean: false }).clean().isValid()).toBe(true);
});
