...
import { cleanPhoneNumber, dropLeading, getRegexString, internationalize, localize, removeSpecialChars } from "../utils.js";
...
test("it gets regex", () => {
    expect(getRegexString('265', ['88', '89'], 7)).toStrictEqual("^(?:265|0|\\+265)?(?:88\\d{7}|89\\d{7})$");
}
);
